...
// ver 2.1 for Project #4                                          //
// Jim Fawcett,Nitish Kumar CSE681-OnLine, Summer 2017             //
/////////////////////////////////////////////////////////////////////
/*
 * Added references to:
 * - System.ServiceModel
 ...
 * --------------------
 * ver 2.1: 12/06/2017
 * -some minor changes including Data contract test,count,kill,file and a new storage environment RepoEnvironment
 * ver 2.0 : 19 Oct 2017
...
namespace MessagePassingComm
{
    ...
    {
        public const string fileStorage = "../../../MockRepo/RepoStorage";
        public const long blockSize = 1024;
        public static string baseAddress { get; set; }
        public static bool verbose { get; set; }
    }
